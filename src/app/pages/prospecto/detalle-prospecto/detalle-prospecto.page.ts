...
// import { DetallemiProspectoervice } from 'src/app/shared/detalle-prospecto.service';
...
export class DetalleProspectoPage implements OnInit {
  ...
  // constructor(public detalleService: DetallemiProspectoervice) { 
  //   this.miProspecto = this.detalleService.miProspecto;
  //   // A rellenar trae info de resultados miProspecto
