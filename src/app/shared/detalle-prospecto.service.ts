...
export class DetalleProspectoService {
  ...
  public prospectoS : Prospecto = new Prospecto();
  ...
  public setProspectoS( imagen:string, nombre:string, laboratorio:string, urlruta:string, secciones:any[]){

    this.prospectoS.srcfoto = 
      "https://cima.aemps.es/cima/fotos/thumbnails/materialas/51347/51347_materialas.jpg";

    this.prospectoS.nombreMed =
      "ASPIRINA C 400 mg/240 mg COMPRIMIDOS EFERVEENTES";
  ...
  public getResultadosProspectos():any[]
  { 
    this.http.get('https://cima.aemps.es/cima/rest/medicamentos?nombre=' + this.medicamento2Buscar).subscribe(
      data =>
      {
        console.log(data);
        this.resultadoBusqueda.push(data);
      });
